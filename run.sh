...
gcc -ffreestanding -fno-stack-protector -fno-pie -c drivers/fileSystem.c -o fileSystem.o -m32

nasm -f elf32 kernel/kernel.asm -o kernelasm.o

ld -melf_i386 -o kernel.bin -Ttext 0x1000 kernelasm.o kernel.o stdio.o string.o video.o keyboard.o ports.o fileSystem.o --oformat binary -T kernel/link.ld
